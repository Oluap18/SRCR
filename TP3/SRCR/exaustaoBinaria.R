...
showCasosTeste <- function() {
  ...
  plot(round(p$result$atual * 2 - 1), temp, xlab = "Valor Correto", ylab = "Valor Previsto",
       col = "black", main = "Existência de Exaustão", pch = 16, cex = .5)
...
#########################################################################################
#######################   IDENTIFICAR A EXISTÊNCIA DE EXAUSTÃO   ########################
#########################################################################################
#######################   0 - NÃO EXISTE SINAIS DE EXAUSTÃO      ########################
#######################   1 - APRESENTA SINAIS DE EXAUSTÃO       ########################
#########################################################################################
...
#Testar variaveis Ã³timas para os dados presentes nos casos de treino
test_optimal("treino")
#Testar variaveis Ã³timas para todos os dados existentes
test_optimal("geral")

#Atualizar com as variÃ¡veis desejadas
